...
void drawChar11x16(u_int c, u_int r, char s, u_int fgColorBGR, u_int bgColorBGR);

void drawString11x16(u_int c, u_int r, char *s, u_int fgColorBGR, u_int bgColorBGR);
